...
const ProductCard = ({ product, index }) => {
  ...
  return (
    ...
    >
      <Link to={`/product/${product.id}`} style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#fff', borderRadius: '24px', padding: '16px', transition: 'transform 0.2s', boxShadow: '0 4px 20px rgba(0,0,0,0.01)' }} 
        ...
        <div style={{ padding: '0 4px' }}>
          <h3 style={{ fontSize: '1rem', fontWeight: 600, color: '#000', marginBottom: '4px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
            {product.title}
          </h3>
